...
public class TestUtils  {
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#homoscedasticT(double[], double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#homoscedasticT(StatisticalSummary, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#homoscedasticTTest(double[], double[], double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#homoscedasticTTest(double[], double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#homoscedasticTTest(StatisticalSummary, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#pairedT(double[], double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#pairedTTest(double[], double[], double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#pairedTTest(double[], double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#t(double, double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#t(double, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#t(StatisticalSummary, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(double, double[], double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(double, double[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(double, StatisticalSummary, double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(double, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(StatisticalSummary, StatisticalSummary, double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.TTest#tTest(StatisticalSummary, StatisticalSummary)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquare(double[], long[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquare(long[][])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTest(double[], long[], double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTest(double[], long[])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTest(long[][], double)
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTest(long[][])
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[], double)
     *
     * @since 1.2
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.OneWayAnova#anovaFValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.OneWayAnova#anovaPValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.OneWayAnova#anovaTest(Collection,double)
     *
     * @since 1.2
     */
    public static boolean oneWayAnovaTest(final Collection<double[]> categoryData,
     ...
     /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#g(double[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gTest( double[],  long[] )
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gTestIntrinsic(double[], long[] )
     * @since 3.1
     */
    public static double gTestIntrinsic(final double[] expected, final long[] observed)
     ...
     /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gTest( double[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#rootLogLikelihoodRatio(long, long, long, long)
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gTestDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.GTest#gTestDataSetsComparison(long[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], double)
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#exactP(double, int, int, boolean)
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#approximateP(double, int, int)
     * @since 3.3
     */
    ...
    /**
     * @see org.apache.lucene.util.hnsw.math.stat.inference.KolmogorovSmirnovTest#monteCarloP(double, int, int, boolean, int)
     * @since 3.3
     */
