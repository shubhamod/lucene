 ...
 *  <ul>
 *   <li>{@link org.apache.lucene.util.hnsw.math.optim}</li>
 *   <li>{@link org.apache.lucene.util.hnsw.math.fitting}</li>
 *  </ul>
 * </h3>
 *
 * <p>
 ...
 * function:
 * <ul>
 *  <li>{@link org.apache.lucene.util.hnsw.math.optimization.univariate.UnivariateOptimizer
 *      UnivariateOptimizer} for {@link org.apache.lucene.util.hnsw.math.analysis.UnivariateFunction
 *      univariate real functions}</li>
 *  <li>{@link org.apache.lucene.util.hnsw.math.optimization.MultivariateOptimizer
 *      MultivariateOptimizer} for {@link org.apache.lucene.util.hnsw.math.analysis.MultivariateFunction
 *      multivariate real functions}</li>
 *  <li>{@link org.apache.lucene.util.hnsw.math.optimization.MultivariateDifferentiableOptimizer
 *      MultivariateDifferentiableOptimizer} for {@link
 *      org.apache.lucene.util.hnsw.math.analysis.differentiation.MultivariateDifferentiableFunction
 *      multivariate differentiable real functions}</li>
 *  <li>{@link org.apache.lucene.util.hnsw.math.optimization.MultivariateDifferentiableVectorOptimizer
 *      MultivariateDifferentiableVectorOptimizer} for {@link
 *      org.apache.lucene.util.hnsw.math.analysis.differentiation.MultivariateDifferentiableVectorFunction
 ...
 * transform a {@link org.apache.lucene.util.hnsw.math.analysis.MultivariateVectorFunction
 * non-differentiable multivariate vectorial function} by converting it to a {@link
 * org.apache.lucene.util.hnsw.math.analysis.MultivariateFunction non-differentiable multivariate
 * real function} thanks to the {@link
 * org.apache.lucene.util.hnsw.math.optimization.LeastSquaresConverter LeastSquaresConverter} helper class.
 * The transformed function can be optimized using any implementation of the {@link
 * org.apache.lucene.util.hnsw.math.optimization.MultivariateOptimizer MultivariateOptimizer} interface.
 * </p>
 *
 * <p>
