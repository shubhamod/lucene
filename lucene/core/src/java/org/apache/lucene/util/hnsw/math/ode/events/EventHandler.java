...
public interface EventHandler  {
    ...
    enum Action {
         ...
         * org.apache.lucene.util.hnsw.math.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link org.apache.lucene.util.hnsw.math.exception.NoBracketingException
   ...
   * org.apache.lucene.util.hnsw.math.ode.FirstOrderDifferentialEquations
   ...
   *   org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler StepHandler} method {@link
   * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler#handleStep(
   * org.apache.lucene.util.hnsw.math.ode.sampling.StepInterpolator, boolean)
   ...
   * org.apache.lucene.util.hnsw.math.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link org.apache.lucene.util.hnsw.math.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * org.apache.lucene.util.hnsw.math.ode.sampling.FixedStepHandler fixed step handlers}.</p>
