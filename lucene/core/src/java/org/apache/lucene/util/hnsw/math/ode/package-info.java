 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepInterpolator StepInterpolator}
 ...
 * the {@link org.apache.lucene.util.hnsw.math.ode.FirstOrderDifferentialEquations
 ...
 * {@link org.apache.lucene.util.hnsw.math.ode.FirstOrderIntegrator
 ...
 * {@link org.apache.lucene.util.hnsw.math.ode.FirstOrderIntegrator#integrate
 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler StepHandler} interface or a
 * {@link org.apache.lucene.util.hnsw.math.ode.sampling.StepNormalizer StepNormalizer}
 * object wrapping a user-specified object implementing the {@link
 * org.apache.lucene.util.hnsw.math.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface into the integrator before calling the {@link
 * org.apache.lucene.util.hnsw.math.ode.FirstOrderIntegrator#integrate
 ...
 *
 * <p>
 * {@link org.apache.lucene.util.hnsw.math.ode.ContinuousOutputModel
 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler StepHandler} interface are
 * available for general needs ({@link
 * org.apache.lucene.util.hnsw.math.ode.sampling.DummyStepHandler DummyStepHandler}, {@link
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepNormalizer StepNormalizer}) and custom
 ...
 * org.apache.lucene.util.hnsw.math.ode.nonstiff.AdaptiveStepsizeIntegrator
 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepNormalizer StepNormalizer} class can
 ...
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.EulerIntegrator Euler}</td><td>1</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.MidpointIntegrator Midpoint}</td><td>2</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.ClassicalRungeKuttaIntegrator Classical Runge-Kutta}</td><td>4</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.GillIntegrator Gill}</td><td>4</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.ThreeEighthesIntegrator 3/8}</td><td>4</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.LutherIntegrator Luther}</td><td>6</td></tr>
 * </table>
 * </p>
 *
 * <table border="1" align="center">
 ...
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.HighamHall54Integrator Higham and Hall}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.DormandPrince54Integrator Dormand-Prince 5(4)}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.DormandPrince853Integrator Dormand-Prince 8(5,3)}</td><td>8</td><td>5 and 3</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.GraggBulirschStoerIntegrator Gragg-Bulirsch-Stoer}</td><td>variable (up to 18 by default)</td><td>variable</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.AdamsBashforthIntegrator Adams-Bashforth}</td><td>variable</td><td>variable</td></tr>
 * <tr><td>{@link org.apache.lucene.util.hnsw.math.ode.nonstiff.AdamsMoultonIntegrator Adams-Moulton}</td><td>variable</td><td>variable</td></tr>
 * </table>
 * </p>
 *
 * <p>
 * In the table above, the {@link org.apache.lucene.util.hnsw.math.ode.nonstiff.AdamsBashforthIntegrator
 * Adams-Bashforth} and {@link org.apache.lucene.util.hnsw.math.ode.nonstiff.AdamsMoultonIntegrator
