 ...
 */
package org.apache.lucene.util.hnsw.math.geometry.euclidean.threed;
...
import org.apache.lucene.util.hnsw.math.geometry.Point;
import org.apache.lucene.util.hnsw.math.geometry.euclidean.oned.Euclidean1D;
import org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.Euclidean2D;
import org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.PolygonsSet;
import org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.SubLine;
import org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.Vector2D;
...
import org.apache.lucene.util.hnsw.math.geometry.partitioning.BSPTreeVisitor;
import org.apache.lucene.util.hnsw.math.geometry.partitioning.BoundaryAttribute;
import org.apache.lucene.util.hnsw.math.geometry.partitioning.Hyperplane;
import org.apache.lucene.util.hnsw.math.geometry.partitioning.Region;
...
import org.apache.lucene.util.hnsw.math.geometry.partitioning.Transform;
    ...
    private static class RotationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedTransform =
                        org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.Line.getTransform(tP10.getX() - tP00.getX(),
                                                                                           tP10.getY() - tP00.getY(),
                                                                                           tP01.getX() - tP00.getX(),
                                                                                           tP01.getY() - tP00.getY(),
                                                                                           tP00.getX(),
    ...
    private static class TranslationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedOriginal  = (Plane) original;
                cachedTransform =
                        org.apache.lucene.util.hnsw.math.geometry.euclidean.twod.Line.getTransform(1, 0, 0, 1,
                                                                                           shift.getX(),
                                                                                           shift.getY());
