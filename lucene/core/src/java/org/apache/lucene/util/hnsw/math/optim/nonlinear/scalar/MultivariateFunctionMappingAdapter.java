 ...
 * org.apache.lucene.util.hnsw.math.optimization.BaseMultivariateOptimizer#optimize(int,
 * MultivariateFunction, org.apache.lucene.util.hnsw.math.optimization.GoalType, double[])}
 ...
 * {@link org.apache.lucene.util.hnsw.math.optim.nonlinear.scalar.noderiv.SimplexOptimizer
 * SimplexOptimizer}.
 * A better solution is to use an optimizer that directly supports simple bounds like
 * {@link org.apache.lucene.util.hnsw.math.optim.nonlinear.scalar.noderiv.CMAESOptimizer
 * CMAESOptimizer} or
 * {@link org.apache.lucene.util.hnsw.math.optim.nonlinear.scalar.noderiv.BOBYQAOptimizer
 * BOBYQAOptimizer}.
