 ...
 * {@link org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler StepHandler} instance using the
 * {@link org.apache.lucene.util.hnsw.math.ode.FirstOrderIntegrator#addStepHandler addStepHandler}
 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepHandler StepHandler} interface can be called
 ...
 * org.apache.lucene.util.hnsw.math.ode.sampling.StepInterpolator StepInterpolator} object.
 * If regular output is desired (for example in order to write an ephemeris file), then
 * the simpler {@link org.apache.lucene.util.hnsw.math.ode.sampling.FixedStepHandler FixedStepHandler}
 * interface can be used. Objects implementing this interface should be wrapped within a
 * {@link org.apache.lucene.util.hnsw.math.ode.sampling.StepNormalizer StepNormalizer} instance
