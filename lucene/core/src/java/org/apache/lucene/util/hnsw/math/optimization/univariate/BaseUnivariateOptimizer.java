 ...
 * <ul>
 *  <li>{@link org.apache.lucene.util.hnsw.math.optimization.univariate.UnivariateOptimizer}</li>
 * </ul>
 *
...
public interface BaseUnivariateOptimizer<FUNC extends UnivariateFunction>
     ...
     * @throws org.apache.lucene.util.hnsw.math.exception.TooManyEvaluationsException
     * if the maximum evaluation count is exceeded.
     * @throws org.apache.lucene.util.hnsw.math.exception.ConvergenceException if the
     * optimizer detects a convergence problem.
     * @throws IllegalArgumentException if {@code min > max} or the endpoints
     * do not satisfy the requirements specified by the optimizer.
     * @throws org.apache.lucene.util.hnsw.math.exception.NullArgumentException if any
